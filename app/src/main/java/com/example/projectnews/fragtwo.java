...
public class fragtwo extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        v = inflater.inflate(R.layout.activity_fragtwo,container,false);
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        ArrayAdapter<String> a= new ArrayAdapter<String>(getContext(), androidx.appcompat.R.layout.support_simple_spinner_dropdown_item,data);
        spin.setAdapter(a);
        ...
        v2 = getActivity().getLayoutInflater().inflate(R.layout.activity_booking,null);
...
//                        ft.replace(R.id.drawerlayout, new ());
                        ft.commit();
                    }
                });
                ...
                ab.setNeutralButton("cancel", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        ab.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                FragmentTransaction ft = getActivity().getSupportFragmentManager().beginTransaction();
//                                ft.replace(R.id.drawerlayout, new MainActivity());
                                ft.commit();
                            }
                        });
                        ab.show();
